...
const Footer = () => {
  return (
    <footer className="bg-yooboba-dark text-white pt-16 pb-8">
      <div className="container mx-auto px-4 md:px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-gray-300 mt-4">
              Premium quality boba pearls for bubble tea shops and businesses.
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <a href="#" className="text-gray-300 hover:text-white transition-colors">Classic Pearls</a>
              </li>
              <li>
                <a href="#" className="text-gray-300 hover:text-white transition-colors">Specialty Pearls</a>
              </li>
              <li>
                <a href="#" className="text-gray-300 hover:text-white transition-colors">Popping Boba</a>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3 text-gray-300">
              <li className="flex items-start">
                ...
                <span>1234 Boba Street, Tea City, CA 90210</span>
              </li>
              <li className="flex items-start">
                <span className="mr-2">📞</span>
        ...
        <div className="mt-12 pt-8 border-t border-gray-700">
          <p className="text-sm text-gray-400 text-center">
            © {new Date().getFullYear()} YooBoba. All rights reserved.
