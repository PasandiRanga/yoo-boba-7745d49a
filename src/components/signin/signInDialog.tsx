        ...
        <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50">
          <div className="bg-white dark:bg-gray-800 rounded-3xl shadow-xl transform transition-all max-w-md w-full p-6 overflow-hidden">
            <div className="space-y-4">
              ...
              <div className="flex items-center gap-2 bg-gray-100 dark:bg-gray-700 rounded-full px-4 py-3">
                ...
                <input 
                  ...
                  autoComplete="off" 
                  placeholder="Email" 
                  className="bg-transparent border-none w-full focus:outline-none text-gray-700 dark:text-gray-200" 
                  type="email" 
                />
              </div>
