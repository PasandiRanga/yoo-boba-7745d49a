      ...
      <main className="flex-grow">
              ...
              <div>
                <div className="bg-white p-8 rounded-xl shadow-sm mb-8">
                  ...
                  <div className="space-y-6">
                    <div className="flex items-start">
                      <div className="bg-yooboba-light rounded-full p-3 mr-4 text-yooboba-purple">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600">1234 Boba Street</p>
                        <p className="text-gray-600">Tea City, CA 90210</p>
                    ...
                    <div className="flex items-start">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600">info@yooboba.com</p>
                        <p className="text-gray-600">sales@yooboba.com</p>
                      </div>
                    </div>
                ...
                <div className="bg-white p-8 rounded-xl shadow-sm">
                  ...
                  <div className="flex space-x-4">
                    <a href="#" className="bg-yooboba-light text-yooboba-purple p-3 rounded-full hover:bg-yooboba-purple hover:text-white transition-colors">
        ...
        <section className="py-16 bg-gray-50">
          <div className="container mx-auto px-4 md:px-6">
            ...
            <div className="rounded-xl overflow-hidden shadow-sm h-96 bg-gray-200">
